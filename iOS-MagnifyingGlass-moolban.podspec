...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/moolban/iOS-MagnifyingGlass-moolban'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = 'MIT'
  s.author           = { 'ksc89kim' => 'ksc89kim@naver.com' }
  s.source           = { :git => 'https://github.com/moolban/iOS-MagnifyingGlass-moolban.git', :tag => s.version.to_s }
